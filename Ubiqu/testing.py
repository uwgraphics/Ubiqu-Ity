    ...
    if async:
        ...
        while True:
            ...
            if (
                ...
                type(result.info) is dict and
                "current" in result.info and
                type(result.info["current"]) is float and
                "total" in result.info and
                type(result.info["total"]) is float
            ):
                progress_percent = result.info["current"] / result.info["total"] * 100.0
